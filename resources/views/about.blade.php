        ...
        <div class="container">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="col-lg-6 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="{{ asset('assets/img/prime-minister-1.jpg') }}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <!-- <h4>App 2</h4>
                            <p>App</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/prime-minister-1.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                    </div>
...
{{--            <p><img src="{{ asset('assets/img/prime-minister.jpg') }}" style="float:left; height:357px; width:645px" /><img src="{{ asset('assets/img/prime-minister-1.jpg') }}" style="height:367px; width:625px" /></p>--}}
            <p style="text-align:center"><strong><span style="background-color:#dddddd">Honorable Prime Minister Sheikh Hasina distributed prizes on the occasion of the inauguration of Sheikh Russell Digital Lab</span></strong></p>

            <p style="text-align:justify">The establishment of Sheikh Russel Digital Lab (SRDL) is being constructed under the leadership of the honourable State Minister of ICT Division, Mr. Junaid Ahmed Palak MP, and with the support of the honourable Adviser, Mr. Sajib Wazed. Sheikh Russel Digital Lab has been set up in 9001 educational institutions across the country under the overall management of the Senior Secretary of the ICT Department in collaboration with the Director-General and Project Director of the ICT Department, all Deputy Commissioners and Upazila Nirbahi Officers, District Education Officers, District-Upazila ICT Officers, Upazila Secondary Education Officers and all concerned personnel.&nbsp;Following this, in Sheikh Russel Digital Lab Establishment Project (Phase II), there are 5000 &quot;Sheikh Russel Digital Lab&quot; and 300 &quot;Sheikh Russel School of Future&quot; installation activities are ongoing in educational institutions (schools, colleges, madrashas or equivalent educational institutions, government-related educational institutions).</p>

            <h2><span style="font-size:18px"><strong><span style="background-color:#dddddd">Project Background</span></strong></span></h2>

            <p style="text-align:justify">The importance of Digital Bangladesh in apprehending the dream of a self-sufficient Bangladesh cannot be overstated. The government has identified the ICT sector as a way to create a creative and innovative education system, increase employment, improve the overall quality of life of the people and appreciate the dream of Digital Bangladesh. To achieve the Vision 2021 Digital Bangladesh announced and directed by the Honourable Prime Minister, the Department of Information and Communication Technology under the Division of ICT has set up 4001 Sheikh Russel Digital Labs along with 15 in Saudi Arabia, 65 Language Learning Labs and 160 Digital Classrooms in primary schools across the country. The first project was approved at the ECNEC meeting on 23/12/2014 and the project was completed in September 2019.&nbsp;<br />
            ...
            <div class="col-lg-6 col-md-6 portfolio-item filter-web">
                <div class="portfolio-wrap">
                    <img src="{{ asset('assets/img/students.jpg') }}" class="img-fluid" alt="">
                    <div class="portfolio-info">
                        <!-- <h4>Web 3</h4>
                        <p>Web</p> -->
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/img/students.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                            <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <img src="{{ asset('assets/img/lab-image.jpg') }}" class="img-fluid" alt="">
                    <div class="portfolio-info">
                        <!-- <h4>App 2</h4>
                        <p>App</p> -->
                        <div class="portfolio-links">
                            <a href="{{ asset('assets/img/lab-image.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                            <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                        </div>
                    </div>
                </div>
