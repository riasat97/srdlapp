<div class="container">
    ...
    <div class="row main-content" style="">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table3">
            ...
            <tr class="lab-type-box">
                ...
                <td width="80%" height="30" align="left" valign="middle" class="text-center padding010">
                    <img  src="{{asset('images/empty-check-box.png')}}"  alt="checked" style="height: 16px;"> সরকারি
                    <img src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> বেসরকারি
                    <img src="{{asset('images/empty-check-box.png')}}"  alt="checked" style="height: 16px;"> অন্যান্য
                </td>
            </tr>
            ...
            <tr class="lab-type-box">
                ...
                <td width="80%" height="30" align="left" valign="middle" class="padding5_10">
                    @foreach($ins_type as $instyp)
                        <img  src="{{asset('images/empty-check-box.png')}}"  alt="checked" style="height: 16px;"> {{$instyp}}
                    @endforeach
                ...
                <td width="80%" height="30" align="left" valign="middle" class="padding5_10">
                    @if($application->institution_type== ins_type()['technical'])
                        @foreach($ins_level_technical as $inslvl)
                            <img  src="{{asset('images/empty-check-box.png')}}"  alt="checked" style="height: 16px;"> {{$inslvl}}
                        @endforeach
                    @else
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table3">
            ...
            <tr class="td-box">
                ...
                <td width="50%" height="30" align="left" valign="middle" class="padding5_10">
                    <p>বিকল্প প্রতিনিধি/ কমিটির সভাপতির নাম: </p>
                    <br><br>
                    <p>মোবাইল: </p>
                    <br>
                    <p>ইমেইল: </p>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table3">
            ...
            <tr class="td-box">
                <td width="45%" height="30" align="left" valign="middle" class="padding010 border-right">
                    <p>উপজেলা পরিষদ হতে দূরত্ব (কিলোমিটার): </p>
                </td>
                ...
                <td width="55%" height="30" align="left" valign="middle" class="padding010 border-right">
                    ...
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> হ্যাঁ
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> না
                </td>
            </tr>
            </tbody>
        </table>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table3">
            ...
            <tr class="td-box">
                <td width="50%" height="30" align="left" valign="middle" class="padding010 border-right">
                    <p>অক্ষাংশ (LATITUDE): </p>
                </td>

                <td width="50%" height="30" align="left" valign="middle" class="padding010">
                    <p>দ্রাঘিমাংশ (LONGITUDE): </p>
                </td>
            </tr>
    ...
    <div class="row main-content" style="">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table3">
            ...
            <tr class="td-box">
                <td colspan="2" width="100%" height="30" align="left" valign="middle" class="padding5_10">
                    ...
                    @foreach($labs as $key=>$lab)
                        <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> {{$lab}}
                    @endforeach
                </td>
            </tr>
            ...
            <tr class="td-box">
                <td colspan="2" width="100%" height="30" align="left" valign="middle" class="padding5_10">
                    অন্যান্য কম্পিউটার ল্যাব(যদি থাকে):
            ...
            <tr class="td-box">
                <td width="50%" height="30" align="left" valign="middle" class="padding5_10 border-right">
                    ...
                    <img src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> নাই
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> মডেম
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> ব্রডব্যান্ড
                </td>
                <td width="50%" height="30" align="left" valign="middle" class="padding5_10 border-right">
                    ডাটা কানেকশনের জন্য ব্যবহৃত মোবাইল অপারেটর সমূহ (যদি মডেম নির্বাচিত করে থাকেন):
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> গ্রামীনফোন
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> রবি
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> বাংলালিংক
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> এয়ারটেল
                    <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> টেলিটক
                </td>
            </tr>
                ...
                <tr class="td-box">
                    ...
                    <td width="50%" height="100" align="left" valign="middle" class="padding5_10 border-right">
                        <p>
                            ...
                            <img  src="{{asset('images/empty-check-box.png')}}"   alt="checked" style="height: 16px;"> সুপারিশ করা হল না
                        </p>
                        <br>
                        <p>স্বাক্ষর:  </p>
                        <br>
