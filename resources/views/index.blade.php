...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h5><span><a href={{url('/')}}><img src="{{ asset('assets/img/srdl.png') }}" alt="" class="img-fluid"></a><a
                        href={{url('/')}}>Sheikh Russel Digital Lab</a></span></h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1 data-aos="fade-up"><b style="color: purple;">Welcome to </b>Establishment of Sheikh Russel Digital
                    Lab Project (Phase Ⅱ)</h1>
                <h5 data-aos="fade-up" data-aos-delay="400">“Sheikh Russel Digital Lab” is a flagship project of the
                    Government of Bangladesh for meeting the demand of Digital Bangladesh aligned with SDG and for
                    strengthening institutional capacity ensuring the quality of education by the highest use of
                    ICT.</h5>
                <div data-aos="fade-up" data-aos-delay="800">
                    <a href="{{ route('web.selected-institutions') }}" class="btn-get-started scrollto">Sheikh Russel
                        Digital Lab list</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-6">
                    <img src="{{asset('assets/img/government-bangladesh-logo-08FC040E6F-seeklogo.com.png') }}"
                         style="width:112px;height:auto;" class="img-fluid" alt="" data-aos="zoom-in"
                         data-aos-delay="200">
                </div>

                <div class="col-lg-4 col-md-4 col-6">
                    <img src="{{asset('assets/img/ict-division-logo-6C8E3F498E-seeklogo.com.png') }}" class="img-fluid"
                         alt="" data-aos="zoom-in">
                </div>

                <div class="col-lg-4 col-md-4 col-6">
                    <img src="{{asset('assets/img/do-ict-logo-6030E46DD4-seeklogo.com.png') }}"
                         style="width:68px;height:auto;" class="img-fluid" alt="" data-aos="zoom-in"
                         data-aos-delay="100">
                </div>
        ...
        <div class="container">
            ...
            <div class="row content">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                    <p>
                        The Department of Information and Communication Technology has devoted special attention to the
                        Information Technology sector in extending ICT education across the country. To ensure the use
                        and application of ICT and to develop skilled manpower, Sheikh Russel Digital Labs are being
                        established in various educational institutions under the direction of the Honourable Prime
                        Minister on the initiative of the Information and Communication Technology Division and under
                        the supervision of the Department of Information and Communication Technology (DoICT). The goals
                        of establishing those labs are generating a conducive environment of ICT education for primary,
                        secondary, and higher secondary students and providing informational IT training to interested
                        youth with the prospects to acquire profitable employment opportunities at home and abroad.
                    </p>
                    <!-- <ul>
                ...
                <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                    <p>
                        The establishment of Sheikh Russel Digital Lab (SRDL) is being constructed under the leadership
                        of the honourable State Minister of ICT Division, Mr. Junaid Ahmed Palak MP, and with the
                        support of the honourable Adviser, Mr. Sajib Wazed. Sheikh Russel Digital Lab has been set up in
                        9001 educational institutions across the country under the overall management of the Senior
                        Secretary of the ICT Department in collaboration with the Director-General and Project Director
                        of the ICT Department, all Deputy Commissioners and Upazila Nirbahi Officers, District Education
                        Officers, District-Upazila ICT Officers, Upazila Secondary Education Officers and all concerned
                        personnel.
                    </p>
        ...
        <div class="container">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/map.png') }}" data-gallery="portfolioGallery"
                ...
                <div class="col-lg-6 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="{{ asset('assets/img/srdl stats with bg.png') }}" class="img-fluid" alt=""
                             style="height: 496px;">
                        <div class="portfolio-info">
                            <!-- <h4>App 2</h4>
                            <p>App</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/srdl stats with bg.png') }}"
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="description">Improving the quality of education and developing skilled human
                            resources</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p class="description">Creating opportunities for students to become proficient in ICT and to
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <p class="description">Organizing seminars to create awareness and interest in ICT through
                            publicity and exchange of experiences </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h4 class="title"><a
                                href="https://play.google.com/store/apps/details?id=com.reve.vashaguru.app">Vasha Guru
                                APP</a></h4>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <p class="description">Future plans for sustainable project outcomes through supervision,
                            monitoring, evaluation and research</p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="col-lg-12 col-md-12 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        <img src="{{ asset('assets/img/srdl main activities.png') }}" class="img-fluid" alt=""
                             style="padding-left: 80px;">
                        <div class="portfolio-info">
                            <!-- <h4>Web 3</h4>
                            <p>Web</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/srdl main activities.png') }}"
                                   data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i
                                        class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 d-flex align-items-stretch">
                    <div class="card" style='background-image: url("assets/img/pc-troubleshoot.jpg");'
                         data-aos="fade-up" data-aos-delay="100">
                        <div class="card-body">
                            <h5 class="card-title"><a href="">36,020</a></h5>
                            <p class="card-text">TOT training on “ICT in Education Literacy, Troubleshooting &
                                Maintenance” to 36,020 teachers for ten days</p>
                            <div class="read-more"><a href="#more-services"><i class="bi bi-arrow-right"></i> Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="card" style='background-image: url("assets/img/fourth-industrial-revolution.jpg");'
                         data-aos="fade-up" data-aos-delay="200">
                        <div class="card-body">
                            <h5 class="card-title"><a href="">15,000</a></h5>
                            <p class="card-text">TOT training on the use of School of Future Learning Management System
                                (LMS), Digital Content, Attendance System etc to 15,000 teachers</p>
                            <div class="read-more"><a href="#more-services"><i class="bi bi-arrow-right"></i> Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 d-flex align-items-stretch mt-4">
                    <div class="card" style='background-image: url("assets/img/ict\ training.jpg");' data-aos="fade-up"
                         data-aos-delay="100">
                        <div class="card-body">
                            <h5 class="card-title"><a href="">8703</a></h5>
                            <p class="card-text">Trained 8703 teachers on basic ICT Trained 8703 teachers on basic
                                ICT</p>
                            <div class="read-more"><a href="#more-services"><i class="bi bi-arrow-right"></i>Read
                                    More</a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-items-stretch mt-4">
                    <div class="card" style='background-image: url("assets/img/vashaguru.jpg");' data-aos="fade-up"
                         data-aos-delay="200">
                        <div class="card-body">
                            <h5 class="card-title"><a href="">1024</a></h5>
                            <p class="card-text">Master Trained 1024 teachers on the use of vashaguru software (9
                                foreign language learning software) for 20 days</p>
                            <div class="read-more"><a href="http://sheikhrusseldigitallab.gov.bd/trainees.php"><i
            ...
            <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                <img src="{{ asset('assets/img/last-pic-adviser.jpg') }}" class="testimonial-img"
                                     alt="">
                                <h3>SAJEEB WAZED</h3>
                                <h4>Information and Communication Technology Affairs Adviser to the Hon’ble Prime
                                    Minister</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Sajeeb Wazed, is a Bangladeshi-American ICT Consultant and political campaigner. He
                                    is the son of Sheikh Hasina, the Honorable Prime Minister, Government of the
                                    People’s Republic of Bangladesh, and the eldest grandson of the first President of
                                    Bangladesh, the father of nation, the best Bengali of thousand years Bangabandhu
                                    Sheikh Mujibur Rahman. A member of the Awami League, He was a key figure in
                                    formulating the party's vision 2021 manifesto. He is currently serving as the
                                    Honorable Prime Minister’s Information and Communication Technology Affairs
                                    Adviser.Sajeeb Wazed graduated with a B.Sc. in Computer Engineering from the
                                    University of Texas at Arlington in the United States and attended the Kennedy
                                    School of Government at Harvard University, where he earned his Masters in Public
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Nominated Young Global Leader in 2016 by the World Economic Forum. During his
                                    tenure, more than 18,000 government offices across the country were brought under a
                                    dedicated high speed intranet, one of the world's largest web portal consisting of
                                    25,000 government websites established, Bangladesh won ICT’s Sustainable Development
                                    Award and WSIS plus 10 Award from ITU and Public Service Excellence Award from
                                    WITSA.
                                    Elected Member of Parliament (MP) at the age of 28 years and became the youngest MP
                                    in the Ninth Parliament and re-elected in 2014. Minister Palak is very active in the
                                    Parliament to have an accountable government.
                                    Secured National Award on Environment in 2010 handed over by the Prime Minister in
                                    recognition to his role in the large scale tree plantation movement.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                <img src="{{ asset('assets/img/Senior Secretary Sir.jpg') }}" class="testimonial-img"
                                     alt="">
                                <h3>Mr. N M Zeaul Alam PAA</h3>
                                <h4>the Secretary of Information & Communication Technology Division</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Mr. NM ZeaulAlam PAA is, at present, the Senior Secretary of Information and
                                    Communication Technology Division. He is the immediate past Secretary, Coordination
                                    & Reforms of the Cabinet Division. Prior to that, he was the Director General of the
                                    Department of Immigration and Passport. He started his career as Assistant
                                    Commissioner, a member of the Bangladesh Civil Service (Administration) cadre in
                                    1986. He is from BCS-84 batch. He obtained B.Sc. (Hons.) and M.Sc. in Botany from
                                    the University of Chittagong. He did his 2nd Masters from the Brac University on
                                    Governance and Development in 2006. He served in almost all the core posts of the
                                    field administration like Magistrate, Assistant Commissioner (Land), UNO, ADC, ADM,
                                    DC and Divisional Commissioner. Besides, he served as Senior Assistant Secretary,
                                    Deputy Secretary, Joint Secretary and Addl. Secretary in different
                                    Ministries/Divisions. He was the Deputy Project Director of ‘Asrayon’, a project
                                    under the Prime Minister’s office. He also worked as Assistant Returning Officer,
                                    Returning Officer and Divisional Coordinator of National and Local Govt. level
                                    elections.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                            </div>
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Web</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/image0.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>App</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/image2.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p></p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/image1.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Card</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/image3.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>Web</p> -->
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/image5.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title=""><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <iframe width="420" height="305" src="https://www.youtube-nocookie.com/embed/H-L1O6Qd6zA"
                        ...
                        <div class="portfolio-info">
                            ...
                            <div class="portfolio-links">
                                <a href="https://www.youtube-nocookie.com/embed/H-L1O6Qd6zA"
                                   data-gallery="portfolioGallery" class="portfolio-lightbox"
                                   title="Sheikh Russel Digital Lab in six minitues"><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <p>শেখ রাসেল ডিজিটাল ল্যাব ও ডিজিটাল কনটেন্ট প্রস্তুতি বিষয়ে মাননীয় শিক্ষা মন্ত্রী ও
                                উপমন্ত্রী মহোদয়ের সাথে অনুষ্ঠিত আলোচনা সভা</p>
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/digital content.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox"
                                   title="শেখ রাসেল ডিজিটাল ল্যাব ও ডিজিটাল কনটেন্ট প্রস্তুতি বিষয়ে মাননীয় শিক্ষা মন্ত্রী ও উপমন্ত্রী মহোদয়ের সাথে অনুষ্ঠিত আলোচনা সভা"><i
                                        class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>Card 3</h4> -->
                            <p>মাননীয় প্রতিমন্ত্রীর কে, সি, আর জমিলা মজিবর রহমান উচ্চ বিদ্যালয়, সিরাজগঞ্জ সদরে স্থাপিত
                                শেখ রাসেল ডিজিটাল ল্যাবের কক্ষ পরিদর্শন
                            </p>
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/state-minister.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox"
                                   title="মাননীয় প্রতিমন্ত্রীর কে, সি, আর জমিলা মজিবর রহমান উচ্চ বিদ্যালয়, সিরাজগঞ্জ সদরে স্থাপিত শেখ রাসেল ডিজিটাল ল্যাবের কক্ষ পরিদর্শন"><i
                                        class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>Web 3</h4> -->
                            <p>জনাব এন এম জিয়াউল আলম পিএএ, সিনিয়র সচিব, আইসিটি বিভাগ এর লায়ন্স স্কুল এন্ড কলেজ, খুলনায়
                                স্থাপিত শেখ রাসেল ডিজিটাল ল্যাবের কক্ষ পরিদর্শন
                            </p>
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/senior secretary.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title="জনাব এন এম জিয়াউল আলম পিএএ, সিনিয়র সচিব, আইসিটি বিভাগ এর লায়ন্স স্কুল এন্ড কলেজ, খুলনায় স্থাপিত শেখ রাসেল ডিজিটাল ল্যাবের কক্ষ পরিদর্শন
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>Web 3</h4> -->
                            <p>প্রকল্প পরিচালক, শেখ রাসেল ডিজিটাল ল্যাব (২য় পর্যায়)এর কিশোরগঞ্জ সরকারি বালক উচ্চ
                                বিদ্যালয়ে ল্যাব কক্ষ পরিদর্শন
                            </p>
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/PD.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title="প্রকল্প পরিচালক, শেখ রাসেল ডিজিটাল ল্যাব (২য় পর্যায়)এর কিশোরগঞ্জ সরকারি বালক উচ্চ বিদ্যালয়ে ল্যাব কক্ষ পরিদর্শন
                  "><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <!-- <h4>Web 3</h4> -->
                            <p>প্রস্তাবিত Digitalization of Island, Beel and Haor area প্রকল্প এর ডেনমার্কের টিমের এস ও
                                এস চিলড্রেন্স ভিলেজ, বগুড়ায় স্থাপিত ল্যাব কক্ষ পরিদর্শন
                            </p>
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/haor.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox"
                                   title="প্রস্তাবিত Digitalization of Island, Beel and Haor area প্রকল্প এর ডেনমার্কের টিমের  এস ও এস চিলড্রেন্স ভিলেজ, বগুড়ায় স্থাপিত ল্যাব কক্ষ পরিদর্শন"><i
                                        class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            ...
                            <div class="portfolio-links">
                                <a href="{{ asset('assets/img/smart-board.jpg') }}" data-gallery="portfolioGallery"
                                   class="portfolio-lightbox" title="শেখ রাসেল স্কুল অফ ফিউচারে স্থাপিত ডিজিটাল স্মার্ট বোর্ড
                  "><i class="bx bx-plus"></i></a>
                                <!-- <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a> -->
                            </div>
                        </div>
                ...
                <div class="col-lg-12 d-flex align-items-stretch justify-content-center">
                    <div class="member" data-aos="fade-up" data-aos-delay="300">
                        <div class="member-img">
                            <img src="{{ asset('assets/img/pdsrdl.jpeg') }}" class="img-fluid" alt=""
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="member-info">
                            ...
                            <div>
                                <i class="ri-mail-send-line"></i>
                                <p>smshariful85@gmail.com, sharifulsrdl@gmail.com</p>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="member-info">
                            ...
                            <div>
                                <i class="ri-mail-send-line"></i>
                                <p>md.shahalam@doict.gov.bd, shahalam3041@gmail.com</p>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    ...
                    <h4>JV of Optimal IT Ltd; Savvy Techmart Ltd and LAL Sobuz Technology</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                ...
                                <p>4/16 Humayun Road (3rd Flour), Mohammadpur, Dhaka-1207.</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01711-588054</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of IBCS-Primax Software (Bangladesh) Ltd, Leads Training & Consulting Ltd. and Virtual Market Solution Ltd</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of Standard Technologies Ltd., QYS Networking & Solutions Ltd & Liner Technologies Ltd.</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p> 43/2, Ring Road (4" Floor), Shyamoli, Dhaka-1207</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01825-058199</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of AI Soft Bangladesh, Gopalgonj Model Polytechnic Institute and RAM Solutions Ltd</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>Islampara, Gopalgonj Sadar, Gopalgonj -8100</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01713-038062</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of Edu Maker, ADN Eduservice Ltd and ADN Telecom Ltd</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>70/b, Bir Uttam kazi nur-uz-zaman Sarak, Panthapath, Dhaka.</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01766-333986</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of Arena Phone BD Ltd. Innovazione Technologies and Metalex</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>6th floor, Rupayan Center, Mohakhali C/A, Dhaka.</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01814-909696</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of Ezze Technology Ltd and Exes Tech Ltd</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>(7th Floor), Janata Tower, Kawran Bazar, Dhaka</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01814-909696</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of BASE Ltd, Global Brand PVT Ltd & Kloud Technologies Ltd</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>147/D (2nd Floor), Green Road, Dhaka-1205</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01841093270</p>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>JV of Prime Tech Solutions Ltd, Beyond Innovation & Technologies Ltd. and AAIT Solutions</h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            <div>
                                <i class="ri-map-pin-line"></i>
                                <p>TK Bhavan (Level 7), Kazi Nazrul Islam Avenue, Kawran Bazar, Dhaka</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01715-159153</p>
                ...
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            ...
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01911464710 <a href="https://sof.edu.bd/">(Sheikh Russel School of Future)</a>,
                                    01740212121</p>
                            </div>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>ওয়ালটন ডিজি-টেক ইন্ডাস্ট্রিজ লিমিটেড <a href="https://waltonbd.com/contact">(Walton Digi-Tech
                            Industries Limited)</a></h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            ...
                            <div>
                                <a class="btn btn-outline-info" target="_blank"
                                   href="{{ route('showPdf','walton.pdf') }}">Walton Service center List</a>
                            </div>
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>টেলিফোন শিল্প সংস্থা লিমিটেড <a href="https://www.tss.com.bd/">(Telephone Shilpa Sangstha
                            Limited)</a></h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                <div class="col-lg-6">
                    <i class="ri-contacts-book-fill"></i>
                    <h4>হাইপারট্যাগ সলিউশন লিমিটেড <a href="https://hypertagsolutions.com/">(HyperTag Solutions Ltd)</a>
                    </h4>
                </div>
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            ...
                            <div>
                                <i class="ri-mail-send-line"></i>
                                <p>apple.mahmud@tvnlbd.com</p>
                            </div>

                            <div>
                                <i class="ri-phone-line"></i>
                                <p>+8801847158756  (Digital Smart Board)</p>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="col-lg-12 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            ...
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>01977476477(Desktop), 01973438868 (Attendance Reader), 01977476430 (Digital ID Card),
                                    01969633089 (Wifi Router)</p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="contact-about">
                        ...
                        <div class="social-links">
                            <a href="https://www.facebook.com/SRDLICT/" class="facebook"><i class="bi bi-facebook"></i></a>
                            <a href="https://www.instagram.com/sheikhrusseldigitallab.gov.bd/" class="instagram"><i
                                    class="bi bi-instagram"></i></a>
                            <a href="https://www.youtube.com/channel/UCf4oxjrd2RGhrsTLjB7WaOg/videos" class="youtube"><i
                ...
                <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="300">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14604.481370248475!2d90.3744676!3d23.7787286!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xfec009b60808d80a!2sICT%20Tower!5e0!3m2!1sen!2sbd!4v1664944630755!5m2!1sen!2sbd"
            ...
            <div class="col-lg-6 text-lg-left text-center">
                <div class="credits">
                    <div class="col-lg-12 col-md-4 col-6">
                        <img src="{{ asset('assets/img/srdl footer.png') }}" class="img-fluid" alt=""
                             data-aos="zoom-in">
                    </div>
                    <div class="copyright">
