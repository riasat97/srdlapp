...
@if (!Auth::guest())
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ asset("images/srdl_03.jpg") }}"
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2015 <a href="http://www.doict.gov.bd/">DoICT</a>.</strong> All rights reserved.
        </footer>
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
               ...
               {{-- <p class="navbar-text" style="margin-left: -45px; font-size: 20px;">শেখ রাসেল ডিজিটাল ল্যাব স্থাপন প্রকল্প (২য় পর্যায়)</p>--}}
                {{--<a class="navbar-brand" href="#">শেখ রাসেল ডিজিটাল ল্যাব স্থাপন প্রকল্প (২য় পর্যায়)</a>--}}
            </div>
